                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" method="post">
                                ...
                                <!-- <a href="login.php" type="submit" name="register"  class="btn btn-primary btn-user btn-block">
                                    Register Account
                                </a> -->
                                <hr>
...
$_email=$_POST['useremail'];
$password=$_POST['userpassword'];
$query=mysqli_query($con,"INSERT INTO `register`(`name`, `last_name`, `email`, `user_password`) VALUES ('$_name','$last_name','$_email','$password')");
if($query){
    echo"<script>alert('you are registerd')
